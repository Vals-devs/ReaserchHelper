...
async def create_tables():
    ...
    async with engine.begin() as conn:
        ...
        for stmt in [
            ...
            "ALTER TABLE papers ADD COLUMN IF NOT EXISTS file_size_bytes BIGINT DEFAULT 0;",
            ...
            "ALTER TABLE papers ADD COLUMN journal VARCHAR(255);",
            "ALTER TABLE papers ADD COLUMN accreditation VARCHAR(100);",
            "ALTER TABLE papers ADD COLUMN user_id VARCHAR(36);",
            "ALTER TABLE papers ADD COLUMN file_size_bytes BIGINT DEFAULT 0;",
            "ALTER TABLE users ADD COLUMN plan_tier VARCHAR(50) DEFAULT 'free';",
